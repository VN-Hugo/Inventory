...
public class TaiKhoanDTO {
    ...
    public TaiKhoanDTO(int manv, String username, String matkhau, String role, int trangthai) {
        this.manv = manv;
    ...
    public void setManhomquyen(String role) {
        this.role = role;
    }
    ...
    public String toString() {
        return "AccountDTO{" + "manv=" + manv + ", username=" + username + ", matkhau=" + matkhau + ", role=" + role + ", trangthai=" + trangthai + '}';
    }
