...
public class PanelShadow extends JPanel {
    ...
    public PanelShadow(String linkIcon, String title, String content) {
        ...
        iconBackground.putClientProperty(FlatClientProperties.STYLE, ""
        + "arc:30;");
        iconBackground.setLayout(new FlowLayout(1,20,10));

        lblIcon = new JLabel();
        lblIcon.setIcon(new FlatSVGIcon("./Img/svg/" + linkIcon));
        ...
        lblContent.putClientProperty(FlatClientProperties.STYLE, ""
        + "font: 135% $medium.font;");
        this.add(lblContent);
