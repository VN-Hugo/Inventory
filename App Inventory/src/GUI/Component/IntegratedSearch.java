...
public class IntegratedSearch extends JPanel {
    ...
    private void initComponent(String str[]) {
        ...
        txtSearchForm.putClientProperty(FlatClientProperties.TEXT_FIELD_LEADING_ICON, new FlatSVGIcon("Img/svg/search.svg",0.8f));
        txtSearchForm.putClientProperty(FlatClientProperties.STYLE, ""
                + "arc:15;"
                + "borderWidth:0;"
                + "focusWidth:0;"
                + "innerFocusWidth:0;"
        ...
        btnReset.setIcon(new FlatSVGIcon("./Img/svg/refresh.svg"));
