...
public class ChiTietSanPhamDAO implements DAOInterface<ChiTietSanPhamDTO> {
    ...
    public int updateXuat(ChiTietSanPhamDTO t) throws ClassNotFoundException {
        int result = 0;
        try {
             Connection con = ConnectionUtils.getMyConnection();
    ...
    public int reset(ChiTietSanPhamDTO t) throws ClassNotFoundException {
        int result = 0;
        try {
            Connection con = ConnectionUtils.getMyConnection();
    ...
    public int deletePn(int t) throws ClassNotFoundException {
        int result = 0;
        try {
             Connection con = ConnectionUtils.getMyConnection();
    ...
    public ArrayList<ChiTietSanPhamDTO> selectAllByMaPhieuXuat(int maphieunhap) throws ClassNotFoundException {
        ArrayList<ChiTietSanPhamDTO> result = new ArrayList<>();
        try {
             Connection con = ConnectionUtils.getMyConnection();
