...
public class PhieuNhapDAO implements DAOInterface<PhieuNhapDTO> {
    ...
    public ArrayList<PhieuNhapDTO> statistical(long min, long max) throws ClassNotFoundException {
        ArrayList<PhieuNhapDTO> result = new ArrayList<>();
        try {
            Connection con = ConnectionUtils.getMyConnection();
    ...
    public boolean checkCancelPn(int maphieu) throws ClassNotFoundException{
    ...
    public int cancelPhieuNhap(int maphieu) throws ClassNotFoundException{
        int result = 0;
