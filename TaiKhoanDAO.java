...
public class TaiKhoanDAO implements DAOInterface<TaiKhoanDTO>{
    ...
    public int insert(TaiKhoanDTO t) {
        ...
        try {
            ...
            String sql = "INSERT INTO TaiKhoan(mataikhoan,tendangnhap,matkhau,manhomquyen,manv,trangthai) VALUES (?,?,?,?,?,?)";
    ...
    public void updatePass(String email, String password) throws ClassNotFoundException{
        int result;
        try {
             Connection con = ConnectionUtils.getMyConnection();
